...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>RUMAH SAKIT NADITYA WISNA &mdash; Login</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Rumah Sakit Terbaik di Bali" />
	...
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="../_assets/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="../_assets/css/bootstrap.css">
	<!-- Flexslider  -->
	<link rel="stylesheet" href="../_assets/css/flexslider.css">
	<!-- Theme style  -->
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<h1 id="fh5co-logo"><a href="index.html">NADITYA WISNA</a></h1>
				   			...
				   			<div class="row">
					   			<div class="col-md-8 col-md-offset-2 text-center js-fullheight slider-text">
					   				<div class="slider-text-inner">
										<h1>RUMAH SAKIT <strong></strong> NADITYA WISNA</h1>
										<h2>Rumah Sakit terbaik di Bali</h2>
